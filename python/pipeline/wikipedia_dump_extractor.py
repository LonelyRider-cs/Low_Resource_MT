...
class Extractor(object):
    ...
    def extract(self, out):
        ...
        #write_f = open("nav.txt", "a+")
        #for text_item in text:
        #    temp = text_item.split('.')
        #    for temp_item in temp:
        #        if temp_item == '':
        #            continue
        #        else:
        #            print(temp_item.replace('\n', ''))
        #            write_f.write(str(temp_item.replace('\n', '')) + '\n')
        #write_f.close()
...
def main():
    ...
    #groupO.add_argument("-dpe" "--dynamic_programming_encoding",
    #                    help="outputs all sentences and titles to a single line in a .txt file")
    ...
    #options.dynamic_programming_encoding =  args.dynamic_programming_encoding
